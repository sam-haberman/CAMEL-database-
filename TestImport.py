...
req.delete(added_exp__url, headers=auth_header)
...
field_id = answer['id']
added_field_id = field_id + "/" + str(field_id)
...
req.put(added_field_id, headers=auth_header, json=update_field)

# Delete this field again
req.delete(added_field_id, headers=auth_header)
